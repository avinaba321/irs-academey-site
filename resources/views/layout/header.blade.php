    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="header-cta">
                    <button onclick="translatePage('fr')" class="btn btn-sm btn-outline-primary me-2">
                        🇫🇷 FR
                    </button>

                    <button onclick="translatePage('en')" class="btn btn-sm btn-outline-secondary me-3">
                        🇬🇧 EN
                    </button>
                    <a href="javascript:void(0);" class="btn btn-login glow-animate" data-bs-toggle="modal"
                        data-bs-target="#loginPopup">
                        Login
                    </a>

                    <a href="javascript:void(0);" class="btn btn-register glow-animate" data-bs-toggle="modal"
                        data-bs-target="#enrollPopup">Register</a>
                </div>
