...
<div class="col-md-3">
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        {{-- ✅ NEW COURSE MATERIAL BUTTON {{ route('admin.batch.materials', $batch->id) }} --}}
                                        <a href="{{ route('admin.batch.materials', $batch->id) }}" class="dropdown-item text-success">
                    ...
                    <div class="modal-body">
                        <form id="batchForm" data-parsley-validate>
                            ...
                            <div class="mt-3">
                                ...
                                <select class="form-select" id="bStudents" multiple>
                                </select>
                            </div>
                            ...
                            <div class="mt-3">
                                <label class="form-label">Select Students *</label>
                                <select class="form-select" id="bStudents" multiple></select>
                            </div>
                ...
                <div class="modal-content rounded-4">
                    ...
                    <div class="modal-body">
                        <form id="batchForm" data-parsley-validate>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Select Students *</label>
                                <select class="form-select" id="bStudents" multiple size="6">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Trainer Name *</label>
                                <input type="text" class="form-control" id="bTrainer" required
                                    placeholder="e.g., John Doe" data-parsley-required-message="Trainer name is required">
                                <div class="invalid-feedback" id="error-trainer_name"></div>
                            </div>
                            ...
                            <!-- Batch Days -->
                            <div class="mb-3">
                                <label class="form-label">Batch Days *</label>

                                <div class="row g-2">
                                    <div class="col-4">
                                        <div class="form-check">
                                            <input class="form-check-input batch-day" type="checkbox" value="Sunday"
                                                id="daySun">
                                    ...
                                    <div class="col-4">
                                        <div class="form-check">
                                            <input class="form-check-input batch-day" type="checkbox" value="Monday"
                                                id="dayMon">
                                    ...
                                    <div class="col-4">
                                        <div class="form-check">
                                            <input class="form-check-input batch-day" type="checkbox" value="Tuesday"
                                                id="dayTue">
                                    ...
                                    <div class="col-4">
                                        <div class="form-check">
                                            <input class="form-check-input batch-day" type="checkbox" value="Wednesday"
                                                id="dayWed">
                                    ...
                                    <div class="col-4">
                                        <div class="form-check">
                                            <input class="form-check-input batch-day" type="checkbox" value="Thursday"
                                                id="dayThu">
                                    ...
                                    <div class="col-4">
                                        <div class="form-check">
                                            <input class="form-check-input batch-day" type="checkbox" value="Friday"
                                                id="dayFri">
                                    ...
                                    <div class="col-4">
                                        <div class="form-check">
                                            <input class="form-check-input batch-day" type="checkbox" value="Saturday"
                                                id="daySat">
                                ...
                                <div class="invalid-feedback" id="error-batch_days"></div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Batch Timing *</label>
                                <input type="text" class="form-control" id="bTiming"
                                    placeholder="e.g., Mon-Fri 10:00 AM - 12:00 PM" required
                                    data-parsley-required-message="Batch timing is required">
                                <div class="invalid-feedback" id="error-batch_timing"></div>
                            </div>
        ...
        <script>
            ...
            function saveBatch() {
                ...
                const selectedStudents =
                    Array.from(document.getElementById('bStudents').selectedOptions)
    ...
    <div class="col-12 col-md-6 col-xl-4">
        ...
        <script>
            document.getElementById('bCourse').addEventListener('change', loadStudents);
            document.getElementById('bStart').addEventListener('change', loadStudents);

            function loadStudents() {

                const courseId = document.getElementById('bCourse').value;
                const startDate = document.getElementById('bStart').value;

                if (!courseId) return;

                fetch(`/admin/course/${courseId}/students?start_date=${startDate}`)
                    .then(res => res.json())
                    .then(data => {

                        const studentSelect = document.getElementById('bStudents');
...
<script>
    ...
    function openAddBatch() {
        ...
        const studentSelect = document.getElementById('bStudents');
        if (studentSelect) {
            studentSelect.innerHTML = '<option disabled>Select course first</option>';
        }
    ...
    function saveBatch() {
        ...
        // ✅ FIX: Get selected students BEFORE creating payload
        const studentSelect = document.getElementById('bStudents');
        const selectedStudents = studentSelect 
            ? Array.from(studentSelect.selectedOptions).map(option => option.value)
            : [];
        ...
        const payload = {
            ...
            meeting_link: bMeeting.value,
            status: bStatus.value,
            students: selectedStudents  // ✅ Add students to payload
        };
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        searchInput.addEventListener('input', function() {
            ...
            batchCols.forEach(col => {
                ...
                const batchName = card.querySelector('.batch-title')?.innerText.toLowerCase() || '';
                const courseName = card.querySelector('.batch-course')?.innerText.toLowerCase() || '';
                const details = card.querySelector('.batch-details-list')?.innerText.toLowerCase() || '';
...
<script>
    ...
    function filterBatches() {
        ...
        fetch(`{{ route('admin.batches.filter') }}?${params.toString()}`)
            ...
            .catch(err => {
                ...
                alert('Failed to filter batches');
            });
    }
    ...
    function buildBatchCard(batch) {
        ...
        // ✅ Escape JSON properly for onclick
            ...
            <div class="batches-card shadow-sm">
                ...
                <div class="d-flex justify-content-between align-items-start mb-3">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a class="dropdown-item" href="#" onclick='openEditBatch(${batchJSON}); return false;'>
                                    <i class="bi bi-pencil"></i> Edit
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item text-danger" href="#" onclick="deleteBatch(${batch.id}); return false;">
                                    <i class="bi bi-trash"></i> Delete
                                </a>
                            </li>
                        </ul>
                ...
                <h6 class="batch-title mb-1">${batch.batch_name}</h6>
                <p class="batch-course mb-3">${batch.course?.title ?? batch.course_name ?? 'N/A'}</p>
                ...
                <div class="batch-footer">
                    ...
                    ${statusMap[batch.status] ?? '<span class="badge bg-secondary">Unknown</span>'}
                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const startDateInput = document.getElementById('bStart');

        if (courseSelect) {
            courseSelect.addEventListener('change', loadStudents);
        }
        if (startDateInput) {
            startDateInput.addEventListener('change', loadStudents);
        }
    });
        ...
        fetch(`/admin/course/${courseId}/students?start_date=${startDate}`)
            ...
            .then(data => {
                ...
                if (!data || data.length === 0) {
                    studentSelect.innerHTML = '<option disabled>No eligible students found</option>';
                    return;
                }
...
@endpush --}}
    ...
    @push('scripts')
        <script>
            ...
            let batchModalEl, batchModal, batchModalTitle;
            let bId, bName, bCourse, bTrainer, bStart, bEnd, bTiming, bMeeting, bStatus;

            function initializeBatchModal() {
                batchModalEl = document.getElementById("batchModal");
                if (!batchModalEl) {
                    console.error('Batch modal not found');
                    return;
                }

                batchModal = new bootstrap.Modal(batchModalEl);
                batchModalTitle = document.getElementById("batchModalTitle");

                // Get form elements
                bId = document.getElementById("batchId");
                bName = document.getElementById("bName");
                bCourse = document.getElementById("bCourse");
                bTrainer = document.getElementById("bTrainer");
                bStart = document.getElementById("bStart");
                bEnd = document.getElementById("bEnd");
                bTiming = document.getElementById("bTiming");
                bMeeting = document.getElementById("bMeeting");
                bStatus = document.getElementById("bStatus");

                // Add event listeners
                if (bCourse) {
                    bCourse.addEventListener('change', loadStudents);
                }
                if (bStart) {
                    bStart.addEventListener('change', loadStudents);
                }
            }

            function openAddBatch() {
                if (!batchModal) {
                    console.error('Batch modal not initialized');
                    return;
                }

                if (batchModalTitle) batchModalTitle.innerText = "Add Batch";
                if (bId) bId.value = "";
                if (bName) bName.value = "";
                if (bCourse) bCourse.value = "";
                if (bTrainer) bTrainer.value = "";
                if (bStart) bStart.value = "";
                if (bEnd) bEnd.value = "";
                if (bTiming) bTiming.value = "";
                if (bMeeting) bMeeting.value = "";
                if (bStatus) bStatus.value = "";

                const studentSelect = document.getElementById('bStudents');
                if (studentSelect) {
                    studentSelect.innerHTML = '<option disabled selected>Select course first</option>';
                }

                document.querySelectorAll('.batch-day').forEach(cb => cb.checked = false);
            ...
            function openEditBatch(batch) {
                ...
                if (batchModalTitle) batchModalTitle.innerText = "Edit Batch";
                if (bId) bId.value = batch.id || "";
                if (bName) bName.value = batch.batch_name || "";
                if (bCourse) bCourse.value = batch.course_id || "";
                if (bTrainer) bTrainer.value = batch.trainer_name || "";
                if (bStart) bStart.value = batch.start_date || "";
                if (bEnd) bEnd.value = batch.end_date || "";
                if (bTiming) bTiming.value = batch.batch_timing || "";
                if (bMeeting) bMeeting.value = batch.meeting_link || "";
                if (bStatus) bStatus.value = batch.status || "";

                if (batch.batch_days) {
                    document.querySelectorAll('.batch-day').forEach(cb => {
                        cb.checked = batch.batch_days.includes(cb.value);
                    });
                }
            ...
            function saveBatch() {
                ...
                const selectedStudents = studentSelect ?
                    Array.from(studentSelect.selectedOptions).map(option => option.value) : [];
                const selectedDays = Array.from(document.querySelectorAll('.batch-day:checked'))
                    .map(cb => cb.value);
                    ...
                    .catch(err => {
                        ...
                        if (err.errors) {
                            Object.keys(err.errors).forEach(field => {
                                ...
                                const inputField = document.getElementById(field.replace('_', '').charAt(0)
                                    .toLowerCase() + field.replace('_', '').slice(1));
            ...
            //             if (!data || data.length === 0) {
            //                 studentSelect.innerHTML = '<option disabled selected>No eligible students found</option>';
            //                 return;
            //             }
    ...
    //                     </option>`;
            ...
            //         .catch(err => {
            //             console.error('Error loading students:', err);
            //             studentSelect.innerHTML = '<option disabled selected>Error loading students</option>';
            //             studentSelect.disabled = false;
            //         });
            // }
                        ...
                        data.forEach(student => {
                            ...
                            const badge = student.badge ||
                                (student.payment_type === 'full' ?
                                    '✓ Full Payment' :
                                    `✓ ${student.paid_installments}/${student.total_installments} Installments`);

                            studentSelect.innerHTML += `
                    <option value="${student.id}">
                        ${student.full_name || student.name} (${student.student_id}) - ${badge}
                    </option>`;
                        });
                    })
                    .catch(err => {
